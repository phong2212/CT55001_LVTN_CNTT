export default function NotFound() {
    return (
        <main className="container mx-auto mb-52 grid min-h-full place-items-center pt-24 mt-24 caret-transparent">
            <div className="text-center pt-10">
                ...
                <a className="link" href='/' aria-label="Về trang chủ">Về trang chủ</a>
