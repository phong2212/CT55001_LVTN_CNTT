...
function CreateImg() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const hotelData = { ...formData, imageUrl };
            const res = await axios.post("/api/upload", hotelData);
        ...
        <form className='container px-20' onSubmit={handleSubmit}>
            <div className="space-y-12">
                <div className="border-b border-gray-900/10 pb-12">
                    <h2 className="text-2xl mb-8 text-center font-semibold leading-7">Thêm hình ảnh mới</h2>
                    <div className="relative">
                        ...
                        {renderInput("imageTitle", "Tên Hình ảnh", formData.imageTitle, "imageTitle", "text")}
                    </div>
                    <div className="mt-4">
